...
public class PendingOrderFetcherRest extends AsyncTask<String, Void, List<Order>>{
	public static final int DIALOG_DOWNLOAD_PROGRESS = 0;
	private ProgressDialog mProgressDialog;
	private Context context;

	public PendingOrderFetcherRest(Context context) 
	{
	...
	protected List<Order> doInBackground(String... urls) {
		...
		String URL = "https://orderbuzz-orderbuzz.rhcloud.com/orderbuzz/order/getorders/"+restId+"/pending";
	...
	protected void onPostExecute(List<Order> orderList) {
		...
		if (orderList != null )
		{
			...
			((PendingOrderListViewActivity)context).onTaskCompletedd(orderList);
		}
	}
}
